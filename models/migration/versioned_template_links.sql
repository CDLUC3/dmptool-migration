...
MODEL (
  ...
  audits (
    unique_combination_of_columns(columns := (versionedTemplateId, url)),
    not_null(columns := (versionedTemplateId, type, url, text, created, createdById, modified, modifiedById))
  ),
  enabled true
);
