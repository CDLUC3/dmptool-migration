...
WITH primary_project_members AS (
  SELECT
    ...
    u.firstname COLLATE utf8_unicode_ci AS givenName,
    u.surname COLLATE utf8_unicode_ci AS surName,
    u.orcid COLLATE utf8_unicode_ci AS orcid,
    p.owner_email COLLATE utf8_unicode_ci AS email,
    u.id AS createdById,
...
other_project_members AS (
  SELECT
    ...
    c.first_name COLLATE utf8_unicode_ci AS givenName,
    c.last_name COLLATE utf8_unicode_ci AS surname,
    c.orcid COLLATE utf8_unicode_ci AS orcid,
    c.email COLLATE utf8_unicode_ci AS email,
